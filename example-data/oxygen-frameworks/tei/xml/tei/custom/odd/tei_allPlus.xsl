...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.typed-subtypeTyped-5-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.pointing-targetLang-targetLang-6-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.spanning-spanTo-spanTo-2-7-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-p-abstractModel-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-p-abstractModel-structure-l-10-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-ptr-ptrAtts-11-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-ref-refAtts-12-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-list-gloss-list-must-have-labels-13-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relatedItem-targetorcontent1-14-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-l-abstractModel-structure-l-15-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-lg-atleast1oflggapl-16-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-lg-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-s-noNestedS-18-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-span-targetfrom-19-->
...
Only one of the attributes @target and @from may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-span-targetto-20-->
...
Only one of the attributes @target and @to may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-span-tonotfrom-21-->
...
If @to is supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-span-tofrom-22-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-link-linkTargets3-24-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-ab-abstractModel-structure-p-25-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-ab-abstractModel-structure-l-26-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-join-joinTargets3-27-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-catchwords-catchword_in_msDesc-28-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-dimensions-duplicateDim-29-->
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-secFol-secFol_in_msDesc-30-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-signatures-signatures_in_msDesc-31-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-msIdentifier-msId_minimal-32-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relation-reforkeyorname-33-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relation-activemutual-34-->
...
@active and @mutual may be supplied (@active and @mutual)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relation-activepassive-35-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-shift-shiftNew-36-->
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.repeatable-MINandMAXoccurs-37-->


	  <!--RULE -->
   <xsl:template match="*[ @minOccurs  and  @maxOccurs ]" priority="1001" mode="M46">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.identified-spec-in-module-38-->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.deprecated-validUntil-deprecated-39-->


	  <!--RULE -->
   <xsl:template match="tei:*[@validUntil]" priority="1000" mode="M48">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-moduleRef-modref-40-->


	  <!--RULE -->
   <xsl:template match="tei:moduleRef" priority="1000" mode="M49">
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-moduleRef-prefix-not-same-prefix-41-->


	  <!--RULE -->
   <xsl:template match="tei:moduleRef" priority="1000" mode="M50">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-model-no_dup_default_models-42-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-model-no_dup_models-43-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-modelSequence-no_outputs_nor_predicates_4_my_kids-44-->


	  <!--RULE -->
   <xsl:template match="tei:modelSequence" priority="1000" mode="M53">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-sequence-sequencechilden-45-->


	  <!--RULE -->
   <xsl:template match="tei:sequence" priority="1000" mode="M54">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-alternate-alternatechilden-46-->


	  <!--RULE -->
   <xsl:template match="tei:alternate" priority="1000" mode="M55">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-constraintSpec-sch_no_more-47-->


	  <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M56">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-constraintSpec-isosch-48-->


	  <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M57">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-constraintSpec-needrules-49-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-attDef-attDefContents-50-->


	  <!--RULE -->
   <xsl:template match="tei:attDef" priority="1000" mode="M59">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-attDef-noDefault4Required-51-->


	  <!--RULE -->
   <xsl:template match="tei:attDef[@usage eq 'req']" priority="1000" mode="M60">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-attDef-defaultIsInClosedList-twoOrMore-52-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-attDef-defaultIsInClosedList-one-53-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-dataRef-restrictDataFacet-54-->


	  <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M63">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-dataRef-restrictAttRestriction-55-->


	  <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M64">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-rdgGrp-only1lem-56-->


	  <!--RULE -->
   <xsl:template match="tei:rdgGrp" priority="1000" mode="M65">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-variantEncoding-location-variantEncodingLocation-57-->


	  <!--RULE -->
   <xsl:template match="tei:variantEncoding" priority="1000" mode="M66">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-div-abstractModel-structure-l-60-->


	  <!--RULE -->
   <xsl:template match="tei:div" priority="1000" mode="M67">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-div-abstractModel-structure-p-61-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-addSpan-spanTo-62-->


	  <!--RULE -->
   <xsl:template match="tei:addSpan" priority="1000" mode="M69">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-damageSpan-spanTo-64-->


	  <!--RULE -->
   <xsl:template match="tei:damageSpan" priority="1000" mode="M70">
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-delSpan-spanTo-66-->


	  <!--RULE -->
   <xsl:template match="tei:delSpan" priority="1000" mode="M71">
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-subst-substContents1-68-->
