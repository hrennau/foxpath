...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:esp-d2e54225="http://www.w3.org/2001/XInclude"
                xmlns:esp-d2e54297="http://www.w3.org/2001/XInclude"
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-att.typed-subtypeTyped-5-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-att.pointing-targetLang-targetLang-6-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-att.spanning-spanTo-spanTo-2-7-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-p-abstractModel-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-p-abstractModel-structure-l-10-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-ptr-ptrAtts-11-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-ref-refAtts-12-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-list-gloss-list-must-have-labels-13-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-relatedItem-targetorcontent1-14-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-l-abstractModel-structure-l-15-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-lg-atleast1oflggapl-16-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-lg-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-quotation-quotationContents-18-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-div-abstractModel-structure-l-21-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-div-abstractModel-structure-p-22-->
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:dataRef|rng:ref" priority="1000" mode="M27">

		<!--REPORT nonfatal-->
      <xsl:if test="concat(normalize-space(@key), normalize-space(@name)) eq 'data.pointer'">
         <xsl:message>WARNING: reference to deprecated macro — 'data.pointer' will be removed from the TEI on 2018-10-01. (concat(normalize-space(@key), normalize-space(@name)) eq 'data.pointer' / nonfatal)</xsl:message>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M27"/>
   </xsl:template>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:gap" priority="1000" mode="M28">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:unclear" priority="1000" mode="M29">
