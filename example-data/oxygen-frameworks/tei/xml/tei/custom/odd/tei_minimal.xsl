...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_minimal-att.pointing-targetLang-targetLang-6-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-att.spanning-spanTo-spanTo-2-7-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_minimal-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-p-abstractModel-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-p-abstractModel-structure-l-10-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-ptr-ptrAtts-11-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_minimal-ref-refAtts-12-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-list-gloss-list-must-have-labels-13-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-relatedItem-targetorcontent1-14-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_minimal-l-abstractModel-structure-l-15-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-lg-atleast1oflggapl-16-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-lg-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-quotation-quotationContents-18-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_minimal-div-abstractModel-structure-l-21-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-div-abstractModel-structure-p-22-->
