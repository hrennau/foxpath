...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_lite-p-abstractModel-p-7-->
   ...
   <!--PATTERN schematron-constraint-tei_lite-ptr-ptrAtts-9-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_lite-ref-refAtts-10-->
   ...
   <!--PATTERN schematron-constraint-tei_lite-list-gloss-list-must-have-labels-11-->
   ...
   <!--PATTERN schematron-constraint-tei_lite-relatedItem-targetorcontent1-12-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_lite-l-abstractModel-structure-l-13-->
   ...
   <!--PATTERN schematron-constraint-tei_lite-lg-atleast1oflggapl-14-->
   ...
   <!--PATTERN schematron-constraint-tei_lite-lg-abstractModel-structure-l-15-->
   ...
   <!--PATTERN schematron-constraint-tei_lite-div-abstractModel-structure-l-18-->
   ...
   <!--PATTERN schematron-constraint-tei_lite-div-abstractModel-structure-p-19-->
   ...
   <!--PATTERN schematron-constraint-tei_lite-s-noNestedS-20-->
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:gap" priority="1000" mode="M24">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:unclear" priority="1000" mode="M25">
