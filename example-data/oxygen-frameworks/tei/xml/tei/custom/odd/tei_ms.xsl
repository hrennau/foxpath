...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.typed-subtypeTyped-5-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.pointing-targetLang-targetLang-6-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.spanning-spanTo-spanTo-2-7-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-p-abstractModel-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-p-abstractModel-structure-l-10-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-ptr-ptrAtts-11-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-ref-refAtts-12-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-list-gloss-list-must-have-labels-13-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relatedItem-targetorcontent1-14-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_ms-l-abstractModel-structure-l-15-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-lg-atleast1oflggapl-16-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-lg-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-quotation-quotationContents-18-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-link-linkTargets3-19-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-ab-abstractModel-structure-p-20-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-ab-abstractModel-structure-l-21-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-join-joinTargets3-22-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-div-abstractModel-structure-l-25-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-div-abstractModel-structure-p-26-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-reforkeyorname-27-->


	  <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M30">
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-activemutual-28-->
...
@active and @mutual may be supplied (@active and @mutual)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-activepassive-29-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-addSpan-spanTo-30-->


	  <!--RULE -->
   <xsl:template match="tei:addSpan" priority="1000" mode="M33">
   ...
   <!--PATTERN schematron-constraint-tei_ms-damageSpan-spanTo-32-->


	  <!--RULE -->
   <xsl:template match="tei:damageSpan" priority="1000" mode="M34">
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-delSpan-spanTo-34-->


	  <!--RULE -->
   <xsl:template match="tei:delSpan" priority="1000" mode="M35">
   ...
   <!--PATTERN schematron-constraint-tei_ms-subst-substContents1-36-->


	  <!--RULE -->
   <xsl:template match="tei:subst" priority="1000" mode="M36">
   ...
   <!--PATTERN schematron-constraint-tei_ms-catchwords-catchword_in_msDesc-37-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-dimensions-duplicateDim-38-->
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-secFol-secFol_in_msDesc-39-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-signatures-signatures_in_msDesc-40-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-msIdentifier-msId_minimal-41-->
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:gap" priority="1000" mode="M42">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:unclear" priority="1000" mode="M43">
