...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_math-att.typed-subtypeTyped-5-->
   ...
   <!--PATTERN schematron-constraint-tei_math-att.pointing-targetLang-targetLang-6-->
   ...
   <!--PATTERN schematron-constraint-tei_math-att.spanning-spanTo-spanTo-2-7-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_math-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   ...
   <!--PATTERN schematron-constraint-tei_math-p-abstractModel-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_math-p-abstractModel-structure-l-10-->
   ...
   <!--PATTERN schematron-constraint-tei_math-ptr-ptrAtts-11-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_math-ref-refAtts-12-->
   ...
   <!--PATTERN schematron-constraint-tei_math-list-gloss-list-must-have-labels-13-->
   ...
   <!--PATTERN schematron-constraint-tei_math-relatedItem-targetorcontent1-14-->


	  <!--RULE -->
   <xsl:template match="tei:relatedItem" priority="1000" mode="M18">
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_math-l-abstractModel-structure-l-15-->


	  <!--RULE -->
   <xsl:template match="tei:l" priority="1000" mode="M19">
   ...
   <!--PATTERN schematron-constraint-tei_math-lg-atleast1oflggapl-16-->
   ...
   <!--PATTERN schematron-constraint-tei_math-lg-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_math-quotation-quotationContents-18-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_math-div-abstractModel-structure-l-21-->
   ...
   <!--PATTERN schematron-constraint-tei_math-div-abstractModel-structure-p-22-->
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:unclear" priority="1000" mode="M26">
