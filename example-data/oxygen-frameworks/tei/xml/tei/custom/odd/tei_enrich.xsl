...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-att.typed-subtypeTyped-5-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-att.pointing-targetLang-targetLang-6-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-att.spanning-spanTo-spanTo-2-7-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-p-abstractModel-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-p-abstractModel-structure-l-10-->
   ...
   <!--PATTERN isoschematron-constraint-tei_enrich-date-dates-11-->


	  <!--RULE -->
   <xsl:template match="tei:date" priority="1000" mode="M16">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-ptr-ptrAtts-12-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-ref-refAtts-13-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-list-gloss-list-must-have-labels-14-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relatedItem-targetorcontent1-15-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-l-abstractModel-structure-l-16-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-lg-atleast1oflggapl-17-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-lg-abstractModel-structure-l-18-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-div-abstractModel-structure-l-21-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-div-abstractModel-structure-p-22-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-catchwords-catchword_in_msDesc-23-->


	  <!--RULE -->
   <xsl:template match="tei:catchwords" priority="1000" mode="M26">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-dimensions-duplicateDim-24-->


	  <!--RULE -->
   <xsl:template match="tei:dimensions" priority="1000" mode="M27">
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-secFol-secFol_in_msDesc-25-->


	  <!--RULE -->
   <xsl:template match="tei:secFol" priority="1000" mode="M28">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-signatures-signatures_in_msDesc-26-->


	  <!--RULE -->
   <xsl:template match="tei:signatures" priority="1000" mode="M29">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-msIdentifier-msId_minimal-27-->


	  <!--RULE -->
   <xsl:template match="tei:msIdentifier" priority="1000" mode="M30">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relation-reforkeyorname-28-->


	  <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M31">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relation-activemutual-29-->
...
@active and @mutual may be supplied (@active and @mutual)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relation-activepassive-30-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-addSpan-spanTo-31-->


	  <!--RULE -->
   <xsl:template match="tei:addSpan" priority="1000" mode="M34">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-damageSpan-spanTo-33-->


	  <!--RULE -->
   <xsl:template match="tei:damageSpan" priority="1000" mode="M35">
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-delSpan-spanTo-35-->


	  <!--RULE -->
   <xsl:template match="tei:delSpan" priority="1000" mode="M36">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-subst-substContents1-37-->
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:gap" priority="1000" mode="M38">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:unclear" priority="1000" mode="M39">
