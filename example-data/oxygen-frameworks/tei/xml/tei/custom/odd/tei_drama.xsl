...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-att.spanning-spanTo-spanTo-2-7-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-p-abstractModel-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-p-abstractModel-structure-l-10-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-ptr-ptrAtts-11-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-ref-refAtts-12-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-list-gloss-list-must-have-labels-13-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-relatedItem-targetorcontent1-14-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_drama-l-abstractModel-structure-l-15-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-lg-atleast1oflggapl-16-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-lg-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-quotation-quotationContents-18-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-div-abstractModel-structure-l-21-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-div-abstractModel-structure-p-22-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-link-linkTargets3-23-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-ab-abstractModel-structure-p-24-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-ab-abstractModel-structure-l-25-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-join-joinTargets3-26-->
