...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-att.typed-subtypeTyped-5-->
   ...
   <!--PATTERN schematron-constraint-tei_its-att.pointing-targetLang-targetLang-6-->
   ...
   <!--PATTERN schematron-constraint-tei_its-att.spanning-spanTo-spanTo-2-7-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   ...
   <!--PATTERN schematron-constraint-tei_its-p-abstractModel-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_its-p-abstractModel-structure-l-10-->
   ...
   <!--PATTERN schematron-constraint-tei_its-ptr-ptrAtts-11-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-ref-refAtts-12-->
   ...
   <!--PATTERN schematron-constraint-tei_its-list-gloss-list-must-have-labels-13-->
   ...
   <!--PATTERN schematron-constraint-tei_its-relatedItem-targetorcontent1-14-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_its-l-abstractModel-structure-l-15-->
   ...
   <!--PATTERN schematron-constraint-tei_its-lg-atleast1oflggapl-16-->
   ...
   <!--PATTERN schematron-constraint-tei_its-lg-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_its-quotation-quotationContents-18-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-div-abstractModel-structure-l-21-->
   ...
   <!--PATTERN schematron-constraint-tei_its-div-abstractModel-structure-p-22-->
