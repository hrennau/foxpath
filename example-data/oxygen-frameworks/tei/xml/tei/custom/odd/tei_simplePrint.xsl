...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-att.datable.w3c-att-datable-w3c-when-1-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-att.datable.w3c-att-datable-w3c-from-2-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-att.datable.w3c-att-datable-w3c-to-3-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-att.datable-calendar-calendar-4-->
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN isoschematron-constraint-teisimpleprint-att.global.rendition-renditionpointer-5-->


	  <!--RULE -->
   <xsl:template match="tei:*[@rendition]" priority="1000" mode="M9">
   ...
   <!--PATTERN isoschematron-constraint-teisimpleprint-att.global.rendition-corresppointer-6-->


	  <!--RULE -->
   <xsl:template match="tei:*[@corresp]" priority="1000" mode="M10">
      <xsl:variable name="results"
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-att.typed-subtypeTyped-7-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-att.pointing-targetLang-targetLang-8-->
   ...
   <!--PATTERN isoschematron-constraint-teisimpleprint-att.pointing-target-validtarget-9-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-att.spanning-spanTo-spanTo-2-10-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-att.styleDef-schemeVersion-schemeVersionRequiresScheme-11-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-ab-abstractModel-structure-p-12-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-ab-abstractModel-structure-l-13-->
   ...
   <!--PATTERN isoschematron-constraint-teisimpleprint-bibl-noEmptyBibl-14-->
   ...
   <!--PATTERN isoschematron-constraint-teisimpleprint-choice-choiceSize-15-->
   ...
   <!--PATTERN isoschematron-constraint-teisimpleprint-choice-choiceContent-16-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-div-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-div-abstractModel-structure-p-18-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-l-abstractModel-structure-l-19-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-lg-atleast1oflggapl-20-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-lg-abstractModel-structure-l-21-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-list-gloss-list-must-have-labels-22-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-p-abstractModel-p-23-->


	  <!--RULE -->
   <xsl:template match="tei:p" priority="1000" mode="M27">
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-p-abstractModel-structure-l-24-->
   ...
   <!--PATTERN isoschematron-constraint-teisimpleprint-pb-pbposition-25-->


	  <!--RULE -->
   <xsl:template match="tei:pb" priority="1000" mode="M29">
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-ref-refAtts-26-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-relatedItem-targetorcontent1-27-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-s-noNestedS-28-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-subst-substContents1-29-->
   ...
   <!--PATTERN isoschematron-constraint-teisimpleprint-text-headeronlyelement-32-->
