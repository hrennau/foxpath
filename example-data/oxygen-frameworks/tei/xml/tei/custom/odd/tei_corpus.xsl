...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.typed-subtypeTyped-5-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.pointing-targetLang-targetLang-6-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.spanning-spanTo-spanTo-2-7-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-p-abstractModel-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-p-abstractModel-structure-l-10-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ptr-ptrAtts-11-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ref-refAtts-12-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-list-gloss-list-must-have-labels-13-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relatedItem-targetorcontent1-14-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-l-abstractModel-structure-l-15-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-lg-atleast1oflggapl-16-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-lg-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-quotation-quotationContents-18-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-div-abstractModel-structure-l-21-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-div-abstractModel-structure-p-22-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relation-reforkeyorname-23-->


	  <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M26">
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relation-activemutual-24-->
...
@active and @mutual may be supplied (@active and @mutual)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relation-activepassive-25-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-link-linkTargets3-26-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ab-abstractModel-structure-p-27-->


	  <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M30">
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ab-abstractModel-structure-l-28-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-join-joinTargets3-29-->


	  <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M32">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:gap" priority="1000" mode="M33">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:unclear" priority="1000" mode="M34">
