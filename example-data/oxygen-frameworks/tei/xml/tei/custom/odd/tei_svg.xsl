...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.typed-subtypeTyped-5-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.pointing-targetLang-targetLang-6-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.spanning-spanTo-spanTo-2-7-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-p-abstractModel-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-p-abstractModel-structure-l-10-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ptr-ptrAtts-11-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-ref-refAtts-12-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-list-gloss-list-must-have-labels-13-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-relatedItem-targetorcontent1-14-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_svg-l-abstractModel-structure-l-15-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-lg-atleast1oflggapl-16-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-lg-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-quotation-quotationContents-18-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-div-abstractModel-structure-l-21-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-div-abstractModel-structure-p-22-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-link-linkTargets3-23-->


	  <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M26">
   ...
   <!--PATTERN schematron-constraint-tei_svg-ab-abstractModel-structure-p-24-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ab-abstractModel-structure-l-25-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-join-joinTargets3-26-->


	  <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M29">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:gap" priority="1000" mode="M30">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:unclear" priority="1000" mode="M31">
