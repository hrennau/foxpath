...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.typed-subtypeTyped-5-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.pointing-targetLang-targetLang-6-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.spanning-spanTo-spanTo-2-7-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-p-abstractModel-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-p-abstractModel-structure-l-10-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-ptr-ptrAtts-11-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-ref-refAtts-12-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-list-gloss-list-must-have-labels-13-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-relatedItem-targetorcontent1-14-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_odds-l-abstractModel-structure-l-15-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-lg-atleast1oflggapl-16-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-lg-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-quotation-quotationContents-18-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-div-abstractModel-structure-l-21-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-div-abstractModel-structure-p-22-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.repeatable-MINandMAXoccurs-23-->


	  <!--RULE -->
   <xsl:template match="*[ @minOccurs  and  @maxOccurs ]" priority="1001" mode="M30">
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.identified-spec-in-module-24-->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.deprecated-validUntil-deprecated-25-->


	  <!--RULE -->
   <xsl:template match="tei:*[@validUntil]" priority="1000" mode="M32">
   ...
   <!--PATTERN schematron-constraint-tei_odds-moduleRef-modref-26-->


	  <!--RULE -->
   <xsl:template match="tei:moduleRef" priority="1000" mode="M33">
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-moduleRef-prefix-not-same-prefix-27-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-model-no_dup_default_models-28-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-model-no_dup_models-29-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-modelSequence-no_outputs_nor_predicates_4_my_kids-30-->


	  <!--RULE -->
   <xsl:template match="tei:modelSequence" priority="1000" mode="M37">
   ...
   <!--PATTERN schematron-constraint-tei_odds-sequence-sequencechilden-31-->


	  <!--RULE -->
   <xsl:template match="tei:sequence" priority="1000" mode="M38">
   ...
   <!--PATTERN schematron-constraint-tei_odds-alternate-alternatechilden-32-->


	  <!--RULE -->
   <xsl:template match="tei:alternate" priority="1000" mode="M39">
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-sch_no_more-33-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-isosch-34-->


	  <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M41">
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-needrules-35-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-attDefContents-36-->


	  <!--RULE -->
   <xsl:template match="tei:attDef" priority="1000" mode="M43">
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-noDefault4Required-37-->


	  <!--RULE -->
   <xsl:template match="tei:attDef[@usage eq 'req']" priority="1000" mode="M44">
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-defaultIsInClosedList-twoOrMore-38-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-defaultIsInClosedList-one-39-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-dataRef-restrictDataFacet-40-->


	  <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M47">
   ...
   <!--PATTERN schematron-constraint-tei_odds-dataRef-restrictAttRestriction-41-->


	  <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M48">
   ...
   <!--PATTERN schematron-constraint-tei_odds-link-linkTargets3-42-->


	  <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M49">
   ...
   <!--PATTERN schematron-constraint-tei_odds-ab-abstractModel-structure-p-43-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-ab-abstractModel-structure-l-44-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-join-joinTargets3-45-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:gap" priority="1000" mode="M53">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:unclear" priority="1000" mode="M54">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="constraintSpec" priority="1000" mode="M55">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:oVar" priority="1000" mode="M56">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:pVar" priority="1000" mode="M57">
