...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="schema-location" select="'urn:oasis:names:tc:dita:xsd:concept.xsd'"/>
    <xsl:variable name="xml-model-location" select="'urn:oasis:names:tc:dita:rng:concept.rng'"/>
