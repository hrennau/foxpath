...
<xsl:stylesheet version="3.0" 
    ...
    -->
    <xsl:param name="copy.image.resources" as="xs:boolean" select="false()"/>
...
<!--        <xsl:message> CODE MERGE <xsl:copy-of select="$mergeCodeSiblings"/></xsl:message>-->
        ...
        <!-- 
        <xsl:message>7777777777777777 <xsl:copy-of select="$processed"/></xsl:message> 
        -->
...
<!--        <xsl:message>8888888888 <xsl:copy-of select="$processed"/></xsl:message>-->
