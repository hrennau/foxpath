...
set "CLASSPATH=%CLASSPATH%;%DITA_HOME%\plugins\com.oxygenxml.webhelp.classic\lib\ant-contrib-1.0b3.jar"
set "CLASSPATH=%CLASSPATH%;%DITA_HOME%\plugins\com.oxygenxml.webhelp.responsive\lib\ant-contrib-1.0b3.jar"
